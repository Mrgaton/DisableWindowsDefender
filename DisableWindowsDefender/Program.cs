...
namespace DisableWindowsDefender
{
    internal class Program
    {
        ...
        public class WindowsDefender
        {
            ...
            {
                WriteRegristyKey(@"HKEY_CURRENT_USER\Software\Policies\Microsoft\Windows\System", "DisableCMD", "0", RegistryValueKind.DWord);
            }
            ...
            public static void DisableWindowsDefender()
            {
                ...
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\SharedAccess\Parameters\FirewallPolicy\DomainProfile", "DisableNotifications", "1", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\SharedAccess\Parameters\FirewallPolicy\DomainProfile", "EnableFirewall", "0", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\SharedAccess\Parameters\FirewallPolicy\PrivateProfile", "DisableNotifications", "1", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\SharedAccess\Parameters\FirewallPolicy\PrivateProfile", "EnableFirewall", "0", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\SharedAccess\Parameters\FirewallPolicy\PublicProfile", "DisableNotifications", "1", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\SharedAccess\Parameters\FirewallPolicy\PublicProfile", "EnableFirewall", "0", RegistryValueKind.DWord);

                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\WindowsFirewall\DomainProfile", "DisableNotifications", "1", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\WindowsFirewall\DomainProfile", "EnableFirewall", "0", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\WindowsFirewall\PrivateProfile", "DisableNotifications", "1", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\WindowsFirewall\PrivateProfile", "EnableFirewall", "0", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\WindowsFirewall\PublicProfile", "DisableNotifications", "1", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\WindowsFirewall\PublicProfile", "EnableFirewall", "0", RegistryValueKind.DWord);

                CreateRegristyFolder(@"Software\Policies\Microsoft\Windows Defender");
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows Defender", "DisableAntiSpyware", "1", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows Defender", "DisableAntiVirus", "1", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows Defender", "ServiceKeepAlive", "0", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows Defender", "AllowFastService", "0", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows Defender", "DisableRoutinelyTakingAction", "1", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows Defender", "HideExclusionsFromLocalAdmins", "0", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows Defender", "ServiceKeepAlive", "0", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows Defender", "AllowFastService", "0", RegistryValueKind.DWord); ;
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows Defender", "AllowFastServiceStartup", "0", RegistryValueKind.DWord);

                CreateRegristyFolder(@"Software\Policies\Microsoft\Windows Defender\Features");
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows Defender\Features", "DeviceControlEnabled", "0", RegistryValueKind.DWord);

                CreateRegristyFolder(@"Software\Policies\Microsoft\Windows Defender\MpEngine");
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows Defender\MpEngine", "MpEnablePus", "0", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows Defender\MpEngine", "DisableGradualRelease", "1", RegistryValueKind.DWord);

                CreateRegristyFolder(@"Software\Policies\Microsoft\Windows Defender\Real-Time Protection");
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows Defender\Real-Time Protection", "DisableBehaviorMonitoring", "1", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows Defender\Real-Time Protection", "DisableIOAVProtection", "1", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows Defender\Real-Time Protection", "DisableOnAccessProtection", "1", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows Defender\Real-Time Protection", "DisableRealtimeMonitoring", "1", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows Defender\Real-Time Protection", "DisableRoutinelyTakingAction", "1", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows Defender\Real-Time Protection", "DisableScanOnRealtimeEnable", "1", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows Defender\Real-Time Protection", "DisableScriptScanning", "1", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows Defender\Real-Time Protection", "DisableRawWriteNotification", "1", RegistryValueKind.DWord);

                CreateRegristyFolder(@"Software\Policies\Microsoft\Windows Defender\UX Configuration");
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows Defender\UX Configuration", "Notification_Suppress", "1", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows Defender\UX Configuration", "SuppressRebootNotification", "1", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows Defender\UX Configuration", "UILockdown", "1", RegistryValueKind.DWord);

                CreateRegristyFolder(@"Software\Policies\Microsoft\Windows Defender\Reportin");
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows Defender\Reportin", "DisableEnhancedNotifications", "1", RegistryValueKind.DWord);
                ...
                CreateRegristyFolder(@"Software\Policies\Microsoft\Windows Defender\SpyNet");
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows Defender\SpyNet", "DisableBlockAtFirstSeen", "1", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows Defender\SpyNet", "SpynetReporting", "0", RegistryValueKind.DWord);
                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\Software\Policies\Microsoft\Windows Defender\SpyNet", "SubmitSamplesConsent", "2", RegistryValueKind.DWord);

                WriteRegristyKey(@"HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\DeviceGuard\Scenarios\HypervisorEnforcedCodeIntegrity", "Enabled", "0", RegistryValueKind.DWord);
            ...
            public static void EnableWindowsDefender()
            {
                ...
                DeleteRegristyFolderTree(@"Software\Policies\Microsoft\Windows Defender");
                DeleteRegristyFolderTree(@"Software\Policies\Microsoft\Windows Defender\MpEngine");
                DeleteRegristyFolderTree(@"Software\Policies\Microsoft\Windows Defender\Real-Time Protection");
                DeleteRegristyFolderTree(@"Software\Policies\Microsoft\Windows Defender\Reportin");
                DeleteRegristyFolderTree(@"Software\Policies\Microsoft\Windows Defender\SpyNet");
                DeleteRegristyFolderTree(@"Software\Policies\Microsoft\Windows Defender\UX Configuration");
                ...
                DeleteRegristyFolderTree(@"Software\Policies\Microsoft\WindowsFirewall");
            ...
            private static void DeleteRegristyFolderTree(string Key)
            {
                try
                {
                    RegistryKey localMachine = RegistryKey.OpenBaseKey(Microsoft.Win32.RegistryHive.LocalMachine, RegistryView.Registry64);
                    RegistryKey key64Bit = localMachine.OpenSubKey(Key, true);
                    ...
                    Microsoft.Win32.Registry.LocalMachine.DeleteSubKeyTree(Key, false);
                }
            ...
            public static class DefenderSetConfig
            {
                public static void EnableSmartScreen()
                {
                    ...
                    DeleteRegristyFolderTree(@"SOFTWARE\Policies\Microsoft\Windows\System");
                }
